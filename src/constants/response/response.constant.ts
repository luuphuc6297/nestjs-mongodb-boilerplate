...
export const RESPONSE_SERIALIZATION_OPTIONS_META_KEY = 'class_serializer:options'
export const RESPONSE_MESSAGE_PROPERTIES_META_KEY = 'ResponseSerializationPropertiesMetaKey'
